              ...
              <div class="form-card">
                ...
                <form action="checkout" method="post">
                  <div class="form-group">
                    ...
                    <input type="text" name="customerName" placeholder="e.g. Rahul Shah" required autocomplete="name">
                  </div>
                  <div class="form-group">
                    <label>Table Number</label>
                    <input type="number" name="tableNumber" placeholder="e.g. 5" min="1" max="50" required>
                  </div>
